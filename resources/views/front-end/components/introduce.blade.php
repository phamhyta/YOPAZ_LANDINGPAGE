<div class="pt-16 font-sans" style=" background: linear-gradient(135deg, #3C8CE7 0%, #00EAFF 100%)">
            ...
            <div class="mx-10">
                <div class="flex justify-between px-10" style="margin-Top:5.6rem; margin-Bottom:5.6rem">
                    <div class="bg-white rounded-3xl w-1/5 px-5 h-96 items-center drop-shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                        <div class="flex justify-center mt-10">
                            <img src="img/whatwedo/email.png" alt="emailtool"></img>
                        </div>
                    ...
                    <div class="bg-white rounded-3xl w-1/5 px-5 h-96 items-center mx-8 drop-shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                        <div class="relative flex justify-center mt-24 -left-10" style="top:-9rem">
                            <img src="img/whatwedo/reminder.png" alt="reminder"></img>
                        </div>
                        <div class="flex justify-center mb-10" style="margin-Top:-3.8rem">
                            <p class="font-bold text-4xl">Reminder</p>
                        </div>
                    </div>
                    <div class="bg-white rounded-3xl w-1/5 px-5 h-96 items-center drop-shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                        <div class="flex justify-center mt-9">
                            <img src="img/whatwedo/workflow.png" alt="workflow"></img>
                        </div>
                        <div class="flex justify-center mb-10" style="margin-Top:5.5rem">
                            <p class="font-bold text-4xl">Workflow</p>
                        </div>
                    </div>
                    <div class="bg-white rounded-3xl w-1/5 px-5 h-96 items-center drop-shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                        <div class="flex justify-center mt-9">
                            <img src="img/whatwedo/brochure.png" alt="template"></img>
                        </div>
                        <div class="flex justify-center mb-10" style="margin-Top:4.5rem">
            ...
            <div class='flex justify-center font-bold text-5xl'>
                <p class="text-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">YOPAZ|</p>
                <p class="text-cyan-400 px-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">Products </p>
                <p class="text-yellow-400">and </p>
                <p class="text-green-400 px-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">Services</p>
            </div>
            <div>
                <div class="flex relative top-10 justify-center">
                    <div class="flex justify-center">
                        <p class="text-white font-bold text-4xl pt-4">Wanna know more? Click here</p>
                    </div>
                    <div class="mt-3 ml-12 w-1/4 flex justify-center rounded-full" style="height:4rem">
                        <button class="text-white  bg-gradient-to-br from-cyan-200 to-sky-700 font-bold text-4xl justify-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 rounded-2xl px-3">More products</button>
                    </div>
                </div>
